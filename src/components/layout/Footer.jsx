...
const Footer = () => {
  ...
  return (
    <footer className={`py-12 ${theme === 'light' ? 'bg-gray-100' : 'bg-gray-900'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className={`mb-4 max-w-md ${theme === 'light' ? 'text-gray-600' : 'text-gray-400'}`}>
              Creating beautiful digital experiences with clean code and innovative design solutions.
            </p>
          </div>
              ...
              {navItems.map((item) => (
                <li key={item.name}>
                  <motion.a
                    href={item.href}
                    whileHover={{ x: 5 }}
                    className={`${theme === 'light' ? 'text-gray-600 hover:text-blue-500' : 'text-gray-400 hover:text-blue-500'}`}
                  >
                    {item.name}
                  </motion.a>
                </li>
